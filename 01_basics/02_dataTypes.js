...
//alet (3+3)//we are using nodejs, not browser

console.log (3
    +3)     //codes are right but not for good redable so don't do that//

console.log ("Biswa")

let name = "Biswa"     //string data type 
let age = 21            //number
let isLoggedIn = false   // boolean type data type


// below describe abot data type

// number => 2 to power 53
//bigint (if the number are very big this bigint use)
